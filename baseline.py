...
# 读取数据
train = pd.read_csv('C:\\Users\\Buaa-Aladdin\\Downloads\\train_all.csv')
test = pd.read_csv('C:\\Users\\Buaa-Aladdin\\Downloads\\republish_test.csv')
...
df_test.to_csv('C:\\Users\\Buaa-Aladdin\\PycharmProjects\\baseline\\result\\baseline2.csv', index=False)
