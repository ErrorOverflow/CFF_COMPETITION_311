public class LocalTrafficMonthNode {
    ...
    public void select(String[] ref, boolean isFinal) {
        ...
        try {
            this.netServiceNodes[(int) ((Double.valueOf(ref[5])) / this.space[5])].select(ref, false);
            ...
            this.netServiceNodes[(int) ((Double.valueOf(ref[5])) / this.space[5])] = new NetServiceNode(this.space, this.num);
            this.netServiceNodes[(int) ((Double.valueOf(ref[5])) / this.space[5])].select(ref, false);
