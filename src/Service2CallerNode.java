public class Service2CallerNode {
    ...
    public void select(String[] ref, boolean isFinal) {
        ...
        try {
            this._1Nodes[Divide.divide(Double.valueOf(ref[9]), Divide.DIVIDE_NODE9)].select(ref, false);
            ...
            this._1Nodes[Divide.divide(Double.valueOf(ref[9]), Divide.DIVIDE_NODE9)] = new _1Node(space, num);
            this._1Nodes[Divide.divide(Double.valueOf(ref[9]), Divide.DIVIDE_NODE9)].select(ref, false);
        }
    }
